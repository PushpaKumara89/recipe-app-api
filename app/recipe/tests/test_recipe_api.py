...
class PrivateAPITests(TestCase):
    ...
    def test_full_update(self):
        """
        Test updating a recipe with partial update
        """
        recipe = create_recipe(
            user=self.user,
            title='Test Recipe',
    ...
    def test_update_user_returns_error(self):
        """ Test updating a recipe with partial update returns error"""
    ...
    def test_delete_other_user_returns_error(self):
        """ Test deleting a recipe with partial update returns error"""
        new_user = create_user(
            email='usernew@example.com',
            password='newuser123'
        )
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """ Test creste a new recipe with existsting ingredient . """
